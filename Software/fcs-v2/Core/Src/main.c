...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : Radio_DIO0_Pin Radio_TX_Pin Mag_Data_Ready_Pin */
  GPIO_InitStruct.Pin = Radio_DIO0_Pin|Radio_TX_Pin|Mag_Data_Ready_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
...
__weak void ConsoleTask(void const * argument)
{
