...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC5     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(GPIOC, Battery_Voltage_Pin|Radio_Enable_Pin);
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* hqspi)
{
  ...
  /* USER CODE END QUADSPI_MspDeInit 0 */
    ...
    PB6     ------> QUADSPI_BK1_NCS
    */
    HAL_GPIO_DeInit(GPIOB, Flash_QUADSPI_CLK_Pin|Flash_QUADSPI_BK1_NCS_Pin);

    HAL_GPIO_DeInit(GPIOC, Flash_QUADSPI_BK1_IO0_Pin|Flash_QUADSPI_BK1_IO1_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, Radio_SPI1_SCK_Pin|Radio_SPI1_MISO_Pin|Radio_SPI1_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(GPS_UART_TX_GPIO_Port, GPS_UART_TX_Pin);

    HAL_GPIO_DeInit(GPS_UART_RX_GPIO_Port, GPS_UART_RX_Pin);
