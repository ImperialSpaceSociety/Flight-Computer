...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, Radio_RX_Pin|Radio_TX_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Radio_RX_Pin Radio_TX_Pin */
  ...
  /*Configure GPIO pin : Radio_Enable_Pin */
